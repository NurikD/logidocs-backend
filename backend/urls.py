...
from documents.views import DocumentListAPI, DocumentDownloadAPI, DocumentReplaceAPI, DocumentDeleteAPI
...
urlpatterns = [
    ...
    path("api/documents/<int:pk>/delete/", DocumentDeleteAPI.as_view()),    # admin only
